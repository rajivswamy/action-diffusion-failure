...
def get_dataset_pusht(dataset_path: str, pred_horizon, obs_horizon, action_horizon):
    """
    Get the PushT dataset.
    
    :param dataset_path: Path to the zarr dataset.
    :param pred_horizon: Number of steps to predict.
    :param obs_horizon: Number of steps to observe.
    :param action_horizon: Number of steps to execute actions.
    :return: PushTImageDataset instance.
    """
