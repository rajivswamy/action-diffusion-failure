...
from src.envs.sim_pusht.utils import DrawOptions
...
class PushTEnv(gym.Env):
    ...
    @classmethod
    def make_env(cls, args: dict):
        return cls(
            seed=args.get("seed", 0),
            legacy=args.get("legacy", False),
            block_cog=args.get("block_cog", None),
            damping=args.get("damping", None),
            render_size=args.get("render_size", 96),
            reset_to_state=args.get("reset_to_state", None),
            max_episode_length=args.get("max_episode_length", 300),
            randomize_rotation=args.get("randomize_rotation", False),
            scale_low=args.get("scale_low", 1.0),
            scale_high=args.get("scale_high", 1.0),
            scale_aspect_limit=args.get("scale_aspect_limit", 100.0),
            uniform_scaling=args.get("uniform_scaling", False),
            randomize_position=args.get("randomize_position", False),
            rand_pos_scale=args.get("rand_pos_scale", 0.0),
            term_on_success=args.get("term_on_success", True),
        )
